...
i_c2h4 = gas.species_index('C2H4(9)')
i_he = gas.species_index('He(2)')
i_c4h8 = gas.species_index('C4H8(8)') # 1 butene
...
def plotflow(a):
    ...
    fig.savefig(out_dir + '/ratio.png', bbox_inches='tight')
...
def plotZoom(a):
    ...
    out_dir = 'figures'
    os.path.exists(out_dir) or os.makedirs(out_dir)
    fig.savefig(out_dir + '/Zoom.png', bbox_inches='tight')
        ...
        if verbose is True:
            if not n % 100:
                print('  {0:10f}  {1:10f} '.format(dist, *gas[
                    'C2H4(9)', 'C4H8(8)'].X * 1000 * 60 * kmole_flow_rate))
                # print(surf.T)
                # print(gas.P)
