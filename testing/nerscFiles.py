...
for x in array:
    ...
    try:
        shutil.copy2('../../linear-scaling-tests/binding_energies/' + x + '/cantera/chem_annotated.cti','./linearscaling/' + x + '/chem_annotated.cti')
    except:
        print 'cannot find cantera file for %s'%(x)
try:
    shutil.copy2('../../linear-scaling-tests/base/chemkin/species_dictionary.txt','./species_dictionary.txt')
    shutil.copy2('../../linear-scaling-tests/base/cantera/chem_annotated.cti','./chem_annotated.cti')
except:
