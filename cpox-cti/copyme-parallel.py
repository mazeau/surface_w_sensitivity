...
#    # ratio is the worker input, which is each element in ratios
...
#    
#    try:
#        a = monolithFull(gas, surf, temp, ratio_in)
#        plotflow(a)
#        plotZoom(a)
#        gas_out, surf_out, gas_names, surf_names, dist_array, T_array = a
#
...
#for y in ratios:
#    # get the moles in for a certain ratio
#    fo2 = tot_flow / (2. * y + 1 + 79 / 21)
#    fch4 = 2 * fo2 * y
#    far = 79 * fo2 / 21
#    moles_in = [fch4, fo2, far]
#    worker_input.append(moles_in)

#data = pool.map(partial(simulationWorker,gas=gas,surf=surf,temp=t_in),ratios)
#pool.close()
#pool.join()
